...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Agenda</h4>
                </div>
                <div class="col-sm-3 ">
                    <?php if($can_add){ ?>
                                        ...
                                        <table class="table  table-striped table-sm text-left">
                                            <thead class="table-header bg-light">
                                                <tr>
                                                    ...
                                                    <th  class="td-kodeguru"> Guru</th>
                                                    <th  class="td-kodemapel"> Mata Pelajaran</th>
                                                    <th  class="td-kelas"> Kelas</th>
                                                    <th  class="td-materi"> Materi</th>
                                                    <th  class="td-jumlahsiswa"> Jumlah Siswa</th>
                                                    <th  class="td-tidakhadir"> Tanpa Keterangan</th>
