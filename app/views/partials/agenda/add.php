...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Agenda</h4>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="form-group ">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <select required=""  id="ctrl-kodemapel" name="kodemapel"  placeholder="Select a value ..."    class="custom-select" >
                                                            ...
                                                            $selected = $this->set_field_selected('kodemapel',$value, "");
                                                            ?>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <textarea placeholder="Enter Materi" id="ctrl-materi"  required="" rows="5" name="materi" class=" form-control"><?php  echo $this->set_field_value('materi',""); ?></textarea>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-jumlahsiswa"  value="<?php  echo $this->set_field_value('jumlahsiswa',""); ?>" type="number" placeholder="Enter Jumlah Siswa" step="1"  required="" name="jumlahsiswa"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-tidakhadir"  value="<?php  echo $this->set_field_value('tidakhadir',""); ?>" type="number" placeholder="Enter Tanpa Keterangan" step="1"  required="" name="tidakhadir"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-ijin"  value="<?php  echo $this->set_field_value('ijin',""); ?>" type="number" placeholder="Enter Ijin" step="1"  required="" name="ijin"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
